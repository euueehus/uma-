...
namespace uma_
{
    public partial class auto_uma : Form
    {
        ...
        public class Horse
        {
            ...
            public Horse(string name, int speed, int stamina, int burst, int luck, int wit  )
            {
                Name = name;
                Speed = speed;
                Stamina = stamina;
        ...
        {
            new Horse("特別周", 88, 85, 82, 80, 78),
            new Horse("無聲鈴鹿", 95, 70, 90, 75, 76),
            new Horse("小栗帽", 90, 88, 85, 82, 72),
            new Horse("黃金船", 78, 92, 88, 90, 62),
            new Horse("米浴", 75, 90, 70, 70, 74),
            new Horse("伏特加", 91, 76, 93, 78, 77),
            new Horse("大和赤驥", 89, 80, 91, 80, 86),
            new Horse("草上飛", 86, 89, 80, 88, 88),
            new Horse("神鷹", 93, 75, 89, 76, 74),
            new Horse("氣槽", 84, 87, 78, 83, 90),
            new Horse("北部玄駒", 87, 93, 84, 85, 80),
            new Horse("目白麥昆", 82, 95, 75, 79, 88),
            new Horse("帝王光環", 90, 88, 86, 87, 82),
            new Horse("成田白仁", 94, 82, 92, 74, 84),
            new Horse("美浦波旁", 88, 84, 87, 81, 70),
            new Horse("春烏拉拉", 55, 60, 50, 95, 52),
            new Horse("優秀素質", 72, 85, 68, 86, 85),
            new Horse("曼城茶座", 80, 91, 72, 72, 83),
            new Horse("里見光鑽", 85, 90, 80, 84, 82),
            new Horse("醒目飛鷹", 83, 70, 95, 77, 70),
            new Horse("丸善斯基", 96, 72, 94, 80, 78),
            new Horse("菱亞馬遜", 86, 86, 83, 82, 76),
            new Horse("超級小溪", 79, 94, 76, 78, 87),
            new Horse("萊茵實力", 81, 88, 79, 85, 80),
            new Horse("待兼福來", 70, 78, 88, 92, 68),
            new Horse("微光飛駒", 94, 68, 96, 75, 74),
            new Horse("愛麗速子", 92, 75, 97, 70, 96),
            new Horse("青雲天空", 77, 92, 70, 88, 73),
            new Horse("玉藻十字", 85, 83, 81, 83, 79),
            new Horse("魯道夫象徵", 91, 89, 84, 82, 95),
            new Horse("成田大進", 86, 80, 88, 79, 81),
            new Horse("愛慕織姬", 84, 82, 90, 81, 80),
            new Horse("雪之美人", 78, 85, 76, 88, 70),
            new Horse("青竹回憶", 89, 74, 92, 77, 66),
            new Horse("勝利獎券", 83, 87, 80, 84, 64),
            new Horse("目白善信", 80, 86, 79, 85, 76),
            new Horse("菱曙", 76, 90, 75, 83, 72),
            new Horse("真機伶", 87, 78, 91, 80, 89),
            new Horse("富士奇蹟", 90, 84, 86, 82, 86),
            new Horse("大鳴大放", 89, 86, 88, 84, 70),
            new Horse("杏目", 94, 88, 96, 86, 90),
        };
